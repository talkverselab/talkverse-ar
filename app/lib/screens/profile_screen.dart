      ...
      body: ListView(
        ...
        children: [
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.public, title: tr('변종'), subtitle: tr('이집트 아랍어 (مصر) · العامية المصرية')),
          ...
          _SettingsGroup(items: [
            ...
            _SettingItem(icon: Icons.copyright, title: tr('저작권'), subtitle: tr('아랍어유니버스 · 2026')),
          ]),
