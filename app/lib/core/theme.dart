...
class AppColors {
  // 主色 — Rojo (국기 빨강)
  static const Color rojo = Color(0xFF0B6E4F);
  static const Color rojoDeep = Color(0xFF074A35);
  static const Color rojoLight = Color(0xFF3E9C7C);

  // 副色 — Gualda (국기 노랑/금)
  static const Color gualda = Color(0xFFC9A227);
  static const Color gualdaBright = Color(0xFFE6C453);
  static const Color gualdaDeep = Color(0xFF8F711A);
