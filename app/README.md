...
- **리포 이름**: `talkverselab/talkverse-ar` (이전 `talkverse-ar` — GitHub 리다이렉트되지만 remote를 새 이름으로 바꿔 두세요)
  ```
  git remote set-url origin https://github.com/talkverselab/talkverse-ar.git
  ```
